...
QVariantMap ThemeManager::resolveStyle(const QString &themeName, const QVariantMap &customOverrides) {
    ...
    if (name == "pie" || name == "wheel") {
        ...
        style["pillSubmenuColor"]     = "#25161224";
        style["pillSubmenuHoverColor"]= "#45281e3a";
        style["pillSubmenuBorder"]    = "#45bf5af2";
        ...
        style["iconColor"]            = "#ebebf5";
        style["iconHoverColor"]       = "#0a84ff";
        style["submenuAccent"]        = "#ff375f";
        style["centerColor"]          = "#25121218";
        style["centerBorder"]         = "#45ffffff";
        style["centerBorderHover"]    = "#0a84ff";
        style["centerDotColor"]       = "#ebebf5";
        style["centerDotHoverColor"]  = "#0a84ff";
        ...
        style["pillBorderHoverColor"] = "#0071e3";
        style["pillSubmenuColor"]     = "#55f5f3f9";
        style["pillSubmenuHoverColor"]= "#85ebe6f7";
